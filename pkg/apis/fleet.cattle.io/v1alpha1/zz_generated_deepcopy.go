...
func (in *GitRepoSpec) DeepCopyInto(out *GitRepoSpec) {
	*out = *in
	...
	if in.TargetRestrictions != nil {
		in, out := &in.TargetRestrictions, &out.TargetRestrictions
		*out = make([]GitTargetRestriction, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GitTargetRestriction) DeepCopyInto(out *GitTargetRestriction) {
	*out = *in
	if in.ClusterSelector != nil {
		in, out := &in.ClusterSelector, &out.ClusterSelector
		*out = new(v1.LabelSelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GitTargetRestriction.
func (in *GitTargetRestriction) DeepCopy() *GitTargetRestriction {
	if in == nil {
		return nil
	}
	out := new(GitTargetRestriction)
	in.DeepCopyInto(out)
	return out
}
